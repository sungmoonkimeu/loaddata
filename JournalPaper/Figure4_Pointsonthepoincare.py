...
def main():
    ...
    for nn in range(1):
        ...
        ax[1].yaxis.set_label_coords(-0.32, 0.5)
        ax[2].set_ylabel(r'$s_2$')
        ax[2].yaxis.set_label_coords(-0.32, 0.5)
        ax[3].set_ylabel(r'$s_3$')
        ax[3].yaxis.set_label_coords(-0.32, 0.5)
