...
1. SMK has added code for Spider environment
    import plotly.io as pio
    pio.renderers.default ='browser'

2. SMK has patched a function in plotly not to request a cloudservice
(it seems a leftover from previous version, issued here: https://github.com/plotly/plotly.py/issues/1742)

    ### Monkey patch not to use the cloud service in offline mode  ###
    ...
    def render(self, fig_dict):
        ...
        html = to_html(
            ...
            include_mathjax=False,  #'cdc' in original module to use of cloud service
    ...
    pio.base_renderers.BrowserRenderer.render = render
    ### Monkey patch end
...
def render(self, fig_dict):
    ...
    html = to_html(
        ...
        auto_play=self.auto_play,
        include_plotlyjs=True,
        include_mathjax=False,  #'cdc' in original module, for use of a cloud service
        post_script=self.post_script,
        full_html=True,
        animation_opts=self.animation_opts,
        default_width="100%",
